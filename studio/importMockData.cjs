/**
 * Import Mock Data to Sanity (CommonJS version)
 * 
 * Usage: node importMockData.cjs
 */
...
const mockData = {
  personalInfo: {
    ...
    highlights: [
      { icon: "Code2", title: "Clean Code", description: "Writing maintainable, testable, and scalable code" },
      { icon: "Smartphone", title: "Native iOS", description: "Deep expertise in Swift and iOS frameworks" },
      { icon: "Layers", title: "Architecture", description: "MVVM, Clean Architecture, and design patterns" },
      { icon: "CheckCircle2", title: "Code Quality", description: "Unit Testing, UI Test, Screenshot testing, Integration Tests and more" }
    ]
  },
  ...
  projects: [
    {
      ...
      features: ["Real-time stock market data", "Biometric authentication", "AI investment recommendations", "Multi-currency support", "Interactive charts with animations"],
    ...
    },
    {
      ...
      description: "Advanced health and fitness tracking application with Apple Watch integration, personalized workout plans, and comprehensive health metrics.",
      features: ["Apple Watch companion app", "Custom workout builder", "Health metrics dashboard", "Social challenges & leaderboards", "Offline workout tracking"],
    ...
    {
      title: "ShopSphere",
      description: "Next-generation e-commerce platform with AR product preview and intelligent recommendations.",
      features: ["AR product visualization", "Apple Pay integration", "Smart search & filters", "Push notifications", "Wishlist sync across devices"],
    ...
    },
    {
      ...
      description: "Interactive educational platform with video courses and gamification.",
      features: ["Offline content download", "Video playback with captions", "Interactive quizzes", "Progress analytics", "Achievement system"],
    ...
    },
    {
      ...
      description: "Smart travel companion with offline maps and expense tracking.",
      features: ["Offline map navigation", "Trip itinerary planner", "Expense tracker with receipts", "Flight status notifications", "Currency converter"],
    ...
    },
    {
      ...
      features: ["Guided meditation sessions", "Breathing exercise timers", "Sleep stories & sounds", "Daily mindfulness reminders", "Progress tracking & streaks"],
...
async function importData() {
  ...
  try {
    ...
    // 4. Import Projects
    console.log('\n💼 Importing Projects...')
    console.log('⚠️  Note: Upload project images in Sanity Studio after import')
    ...
    console.log('  3. Set REACT_APP_USE_SANITY=true in frontend')
